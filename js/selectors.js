...
$(function(){
    ...
    */
    ...
    $(".btn-danger").on("click", ()=>{
        ...
        $('h3').css('border','25px solid green');
        $('p').css('border','25px solid black');
        $('img').attr('src', 'img/anonymouse.png');
        $('p, h1, h2, h3, aside, button, li').text('You have been hacked');
        $('*').delay(4000).hide(1000);
    });
})